...
f = open(f'{base}/{folder}/noAbs_test2.csv','+w')  # creates a csv document with all outputs
f.write('"Name"\t"obsid"\t"dist(Mpc)"\t"type"\t"epoch"\t"exp_timeA(ks)"\t"exp_timeB(ks)"\t"mean_nH(1e22atoms_cm-2)"\t"RA"\t"DEC"\t"dateXray"\t"countsA"\t"countsB"\t"PhoIndex"\t"confInt(1.6σ)"\t"norm"\t"confInt(1.6σ)"\t"const"\t"cstat"\t"chi2"\t"dof"\t"PhoInd_2_10"\t"confInt(1.6σ)_2_10"\t"absflux_2_10"\t"flux_confInt_2_10(1.6σ)"\t"Lum_2_10"\t"lum_confInt_2_10(1.6σ)"\t"flux_confInt_2_10(3σ)"\t"lum_confInt_2_10(3σ)"\t"PhoInd_3_78"\t"confInt(1.6σ)_3_78"\t"absflux_3_78"\t"flux_confInt_3_78(1.6σ)"\t"Lum_3_78"\t"lum_confInt_3_78(1.6σ)"\t"flux_confInt_3_78(3σ)"\t"lum_confInt_3_78(3σ)"\t"PhoInd_2_78"\t"confInt(1.6σ)_2_78"\t"absflux_2_78"\t"flux_confInt_2_78(1.6σ)"\t"Lum_2_78"\t"lum_confInt_2_78(1.6σ)"\t"flux_confInt_2_78(3σ)"\t"lum_confInt_2_78(3σ)"\t"PhoInd_10_30"\t"confInt(1.6σ)_10_30"\t"absflux_10_30"\t"flux_confInt_10_30(1.6σ)"\t"Lum_10_30"\t"lum_confInt_10_30(1.6σ)"\t"flux_confInt_10_30(3σ)"\t"lum_confInt_10_30(3σ)"\t"PhoInd_10_78"\t"confInt(1.6σ)_10_78"\t"absflux_10_78"\t"flux_confInt_10_78(1.6σ)"\t"Lum_10_78"\t"lum_confInt_10_78(1.6σ)"\t"flux_confInt_10_78(3σ)"\t"lum_confInt_10_78(3σ)"\n')
